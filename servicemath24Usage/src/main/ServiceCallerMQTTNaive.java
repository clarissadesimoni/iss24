...
public class ServiceCallerMQTTNaive {
	...
	public void doJob() {
		try {
			/* 4 */ client = new MqttClient(brokerAddr, "answerconsumer", new MemoryPersistence());
			/* 5 */ client.connect();
			/* 6 */ IApplMessage req = BasicMsgUtil.buildRequest(sender, msgid, msgcontent, destination);
	...
	protected void sendMessageMqtt(IApplMessage m) throws MqttSecurityException, MqttException {
